...
def sample_points_from_meshes(
    ...
    if return_normals and return_textures and return_bary_coord:
        # pyre-fixme[61]: `normals` may not be initialized here.
        # pyre-fixme[61]: `textures` may not be initialized here.
        return samples, normals, textures,  ( sample_face_idxs,w0[:, :, None] ,w1[:, :, None],  w2[:, :, None])
